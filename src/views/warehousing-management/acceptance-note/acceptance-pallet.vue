<template>
  <el-card style="overflow: auto" id="pallet-top-form">
    <el-row>
          ...
          <el-col :span="6">
            <div class="btn-box" style="text-align: right;">
              ...
              <el-button
                ...
                v-if="v.menuKey == 'WMS_ACCEPTANCE_PALLET_COMMODITY' || v.menuKey == 'WMS_ACCEPTANCE_PALLET_DEL'"
                :class="v.className"
    ...
    <self-dialog
      ...
      <el-form :model="form" ref="form" id="dialog-form">
        <el-row>
          <el-col :span="8">
            <el-form-item label="商品名称">
                <el-input v-model="formInline.commodityName" class="inputWidth" maxLength="20"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <span>托盘号</span>
<!--         <el-input v-model="labelNumber" style="width: 166px;" disabled></el-input>
...
<script src="./js/acceptance-pallet.js"></script>
