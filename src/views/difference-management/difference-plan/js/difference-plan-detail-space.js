...
import { getProcessPlanDetail } from '@/api/difference-management/difference-plan/difference-plan-detail-space'
...
export default {
  ...
  created () {
    ...
    let differenceDetail =  JSON.parse(window.localStorage.getItem("differencePlanDetailSpace"))
...
　　　deep: true
  ...
  methods: {
    initBtn () {
      let menusKey = 'WMS_DIFFERENCE_PLAN_DTL_SPACE';
