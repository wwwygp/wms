<template>
  <el-card style="height: calc(100vh);overflow: auto">
    <el-row id="difference-plan-form">
      <el-form :inline="true" :model="formInline">
        <el-row>
          <el-col :span="6">
            <el-form-item label="盘点计划单号">
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="编辑时间">
              <DatePick ref="editComponents" :pickRange="true" @getStartTime="getEditStartTime" @getEndTime="getEditEndTime"></DatePick>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
<script src="./js/difference-plan.js"></script>
<style lang="scss">
#difference-plan-form {
