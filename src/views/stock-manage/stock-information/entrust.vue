<template>
  <el-card style="height: calc(100vh);overflow: auto" class="inventory">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-form-item label="标准:">
              <el-select v-model="formInline.standardId" placeholder="请选择" v-loadmore="loadMoreStandardList" @focus="initStandardList" filterable clearable >
                <el-option
        ...
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item label="材料">
              ...
              <!--<el-select v-model="formInline.materialId" placeholder="请选择" @focus="initMaterialDic" filterable clearable>-->
                <!--<el-option-->
          ...
          <el-col :span="6">
            <el-form-item label="品牌">
              <el-select v-model="formInline.brandId" placeholder="请选择" v-loadmore="loadMoreBrandList" @focus="initBrandList" filterable clearable>
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="材质">
              ...
              <!--<el-select v-model="formInline.textureId" placeholder="请选择" filterable clearable>-->
                <!--<el-option-->
        ...
        <el-row>
          <el-col :span="24" style="text-align: right;">
            ...
            <el-button
              ...
              v-if="v.menuKey=='WMS_STOCK_EXCEL_EXPORT_BY_OWNER'">
              {{v.name}}
            </el-button>
          </el-col>
        </el-row>
    ...
    <el-row class="entrust-table" style="margin-top: -20px;">
      <el-col :span="24">
        <table-configure
          ref="tableConfig"
...
<script src="./js/stock-entrust.js"></script>
<style scoped>
